...
const EditBookingModal = ({ openEditBookingModal, setOpenEditBookingModal }: Props) => {
    return (
        <>
            <Modal dismissible show={openEditBookingModal} onClose={() => setOpenEditBookingModal(false)}>
                <Modal.Header>Edit Booking Room</Modal.Header>
                <Modal.Body>
                ...
                <Modal.Footer>
                    <Button className='bg-[#86B817]' onClick={() => setOpenEditBookingModal(false)}>Edit</Button>
                    <Button color="gray" onClick={() => setOpenEditBookingModal(false)}>
                        Cancel
                    </Button>
                </Modal.Footer>
            </Modal>
